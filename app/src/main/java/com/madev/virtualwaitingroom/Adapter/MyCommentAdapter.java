...
public class MyCommentAdapter extends RecyclerView.Adapter<MyCommentAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
            ...
            Glide.with(context).load(commentModelList.get(position).getPhotoUrl()).into(holder.user_comment_photo);
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        @BindView(R.id.user_comment_photo)
        CircleImageView user_comment_photo;
