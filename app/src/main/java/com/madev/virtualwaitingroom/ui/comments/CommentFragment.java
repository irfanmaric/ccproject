...
import com.madev.virtualwaitingroom.Adapter.MyCommentAdapter;
import com.madev.virtualwaitingroom.Callback.ICommentCallbackListener;
...
public class CommentFragment extends BottomSheetDialogFragment implements ICommentCallbackListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        commentViewModel.getMutableLiveDataBranchList().observe(this, commentModels -> {
